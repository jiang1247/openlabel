...
class TextGraphics : public GraphicsObject
{
  public:
    TextGraphics(int id, Scene *scene = nullptr);
    ...
    virtual int graphicsType() const override;
    virtual QString graphicsName() const override;

    virtual QSizeF initialSize() override;
